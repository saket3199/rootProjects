...
import com.techlab.Person.Person1;

public class Person1Test {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		Person1 person1 = new Person1("Apple", 21, Gender.MALE, 72, 196);
		Person1 person2 = new Person1("Zebra", 20, Gender.FEMALE, 65, 165);
		...
		person1.doEat();
		System.out.println("The weight of the person after eating is: "+person1.getWeight());
		person1.doWorkOut();
		System.out.println("The weight of the person after working out is: "+person1.getWeight());
	}
